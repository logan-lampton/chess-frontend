...
function ViewClubGames() {
  ...
  return (
    <div className='relative'>
      <button className='absolute top-5 right-10 h-15 w-50 bg-gray-900 hover:bg-gray-700 text-white font-bold py-2 px-4 border bg-gray-900 rounded mb-4'>
        <Link
          // to={}
          ...
          <div key={game.id} className='mt-5 mb-5 p-8'>
            <div className='border-2 border-gray-900'>
              <div className='bg-gray-900 text-white font-bold py-2 px-4 border mb-2 flex justify-between'>
                ...
                <button className='text-black p-1 text-sm ml-2'>Cancel Game</button>
              </div>
