  ...
  return (
    <>
      ...
      <div>
        ...
        <div class='relative'>
          <div class='absolute left-25 bg-gray-800 text-white font-bold py-2 px-4 border'>
            <ChessClass />
          </div>
          <div class='absolute right-25 bg-gray-800 text-white font-bold py-2 px-4 border'>
            <ChessClass />
          </div>
        </div>
      </div>
