  ...
  return (
    <>
      ...
      <div>
        ...
        <div class='relative'>
          <div class='absolute left-0 bg-gray-800 text-white font-bold py-2 px-4 border'>
            <ChessClass />
          </div>
          <div class='absolute right-120 bg-gray-800 text-white font-bold py-2 px-4 border'>
            <ChessClass />
          </div>
        </div>
      </div>
